      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full flex items-center justify-center gap-3 h-12 rounded-xl border border-black/10 bg-white font-[Outfit] font-medium text-[14px] text-black/80 transition-colors hover:bg-black/2 cursor-pointer"
          >
            <GoogleIcon />
